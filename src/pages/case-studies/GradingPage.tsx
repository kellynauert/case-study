...
export function GradingPage() {
	return (
		<StudyPage
			...
			intro={
				<StudyBody size={12}>
					Every interactive Item submitted by students flows through the grading system. Grading behavior is defined during authoring and
					...
					the Page requires manual grading, the entire Page enters the grading queue. Automatically graded Items retain their calculated
			...
			<StudySection id='grading-queue' size={12}>
				<StudySectionTitle id='grading-queue' title='Grading Queue' />
				<StudyBody size={12}>
			...
			<StudySection id='scoring' size={12}>
				<StudySectionTitle id='scoring' title='Scoring' />
				<StudyBody size={12}>
					Scoring behavior is configured during Item authoring and requires no additional setup during grading. Pages can be graded in one
					of two ways.
					<br />
					<br />
				</StudyBody>
				<StudySplit
					left={
						<>
							...
							<StudyBody size={12}>
								Each interactive Item receives its own score.
								<br />
								<br />
					...
					right={
						<>
							...
							<StudyBody size={12}>
								Some Pages are evaluated as a single assignment rather than individual Items.
								<br />
								<br />
			...
			<StudySection id='automatic-and-manual-grading' size={12}>
				<StudySectionTitle id='automatic-and-manual-grading' title='Automatic and Manual Grading' />
			...
			<StudySection id='ai-assisted-grading' size={12}>
				<StudySectionTitle id='ai-assisted-grading' title='AI-Assisted Grading' />
				<StudyBody size={12}>
					Open Response Items support AI-assisted grading.
					<br />
					<br />
			...
			<StudySection id='grader-notes' size={12}>
				<StudySectionTitle id='grader-notes' title='Grader Notes' />
				<StudyBody size={12}>
					Grader Notes are configured during Item authoring and displayed only to instructors during grading.
					<br />
					<br />
