...
export const hero = {
	...
	heroVerbOptions: ['Designing', 'Engineering'] as const,
	heroLineOneRest: 'Products.',
	heroLineTwoRest: 'Experiences.',
	heroLineOne: 'Designing Products.',
	heroLineTwo: 'Engineering Experiences.',
